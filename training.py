...
data_path = '../tasks_1-20_v1-2.tar/tasks_1-20_v1-2/en-10k/'
saver_path = "./saver/"
...
def data_read_and_preprocess(data_path, memory_capacity, vali_ratio):
	...
	train = bp.data_to_vector(train, word_dict, maximum_word_in_sentence, memory_capacity, sentence_numbering)
	vali = bp.data_to_vector(vali, word_dict, maximum_word_in_sentence, memory_capacity, sentence_numbering)
	test = bp.data_to_vector(test, word_dict, maximum_word_in_sentence, memory_capacity, sentence_numbering)
...
sess = tf.Session()
model = mn.MemN2N(sess, hop, maximum_word_in_sentence, len(word_dict), embedding_size, memory_capacity, sentence_numbering, lr=lr)
